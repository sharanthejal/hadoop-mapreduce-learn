...
public class EvenOddCount_Driver {
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
		...
		job.setJarByClass(EvenOddCount_Driver.class);
		job.setJobName("EvenOddCount_MR");
		...
		job.setMapperClass(EvenOddCount_Mapper.class);
		job.setReducerClass(EvenOddCount_Reducer.class);
