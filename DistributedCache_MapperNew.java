...
/*
 * Currently using the below class we can read the data from the HDFS fs
 */
public class DistributedCache_MapperNew extends Mapper<LongWritable, Text, Text, DoubleWritable> {
